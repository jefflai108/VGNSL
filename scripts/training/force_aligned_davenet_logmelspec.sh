...
expdir=exp/spokencoco/force_aligned_pretrained-${davenet_embed_type}_${feature}_embed${embed_size}_lr${lr}_${basename}
python src/train.py --logger_name $expdir \
    ...
    --num_epochs 20 --workers 5 --batch_size 64 --margin 0.2 \
    --embed_size ${embed_size} --feature_dim ${feature_dim} --learning_rate ${lr} \
    --speech_hdf5 --feature ${feature} --load_pretrained \
    --davenet_embed --davenet_embed_type $davenet_embed_type --davenet_embed_pretrained
