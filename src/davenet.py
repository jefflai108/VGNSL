...
if __name__ == '__main__':
    state_path = '/data/sls/temp/clai24/pretrained-models/RDVQ_00000/models/best_audio_model.pth'
    args_path = '/data/sls/temp/clai24/pretrained-models/RDVQ_00000/args.pkl'
    ...
    audio_model.load_state_dict(audio_states)
    audio_model.eval()
    num_frames = 2048
    batch_size = 10
    wavs = torch.randn(batch_size, num_frames, 40)
    print(audio_model)
    y, _, _, _ = audio_model(wavs.reshape(batch_size, num_frames, -1))
    print(wavs.shape)
    print(y.mean(dim=(-2,-1)).shape)
